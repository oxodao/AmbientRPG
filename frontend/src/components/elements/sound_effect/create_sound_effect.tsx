...
export default function CreateSoundEffectModal({ scene, close }: Props) {
        ...
        slotProps={{
            paper: {
                ...
                onSubmit: async (event: React.FormEvent<HTMLFormElement>) => {
                    ...
                    formData.set('loop', formData.get('loop') === 'on' ? 'true' : 'false');
                    ...
                    try {
                        await sdk.soundEffects.create(formData);

                        enqueueSnackbar({
                            message: 'Effet sonore crée',
                            variant: 'success',
                        });
                        ...
                        enqueueSnackbar({
                            message: 'Échec de la création de l\'effet sonore',
                            variant: 'error',
                        });
    ...
    >
        <DialogContent>
            <DialogTitle>Création d'un effet sonore</DialogTitle>

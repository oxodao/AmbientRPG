...
# @TODO: Build the frontend app and move it to backend/public/frontend
# @TODO: Modify the caddyfile to serve the frontend as expected
# @TODO: Fill the EMBED variable correctly

# Script config
PHP_VERSION="8.4"
export PHP_VERSION

FRANKENPHP_VERSION="v1.4.3"
...
export PHP_EXTENSIONS="apcu,ctype,curl,dom,fileinfo,filter,iconv,intl,mbstring,opcache,openssl,pcntl,pdo,pdo_sqlite,posix,session,simplexml,sqlite3,tokenizer,xml,xmlreader,xmlwriter,yaml,zlib,zstd"
...
if ! type "composer" >/dev/null 2>&1; then
	echo "The \"composer\" command must be installed."
	exit 1
fi

 ...
 */
final class Version20250219185232 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE character ADD COLUMN class VARCHAR(255) NOT NULL');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('CREATE TEMPORARY TABLE __temp__character AS SELECT id, name, searchable_name, played_by, notes, npc, campaign_id, scene_id FROM character');
        ...
        $this->addSql('INSERT INTO character (id, name, searchable_name, played_by, notes, npc, campaign_id, scene_id) SELECT id, name, searchable_name, played_by, notes, npc, campaign_id, scene_id FROM __temp__character');

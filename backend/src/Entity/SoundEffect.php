...
use App\State\Provider\SoundEffectProvider;
...
#[ApiResource(
    operations: [
        ...
        new Get(
            uriTemplate: '/sound_effects/{id}/download',
            provider: SoundEffectProvider::class,
        ),
...
#[ORM\Entity(repositoryClass: SoundEffectRepository::class)]
#[Vich\Uploadable]
class SoundEffect implements HasCampaignInterface
{
    public const string API_GET_ITEM = 'api:sound_fx:get';
    public const string API_GET_COLLECTION = 'api:sound_fx:get-collection';
    public const string API_CREATE = 'api:sound_fx:create';
    public const string API_UPDATE = 'api:sound_fx:update';
    ...
    #[ORM\ManyToOne(targetEntity: Scene::class, inversedBy: 'soundEffects')]
    ...
    #[ORM\ManyToOne(targetEntity: Campaign::class, inversedBy: 'soundEffects')]
    ...
    #[Vich\UploadableField(mapping: 'sound_effects', fileNameProperty: 'filename')]
    #[Groups([self::API_CREATE])]
